...
<div class="konten">
	...
	<div class="card mb-3 mt-4S" style="max-width: 100%;">
				  <div class="row no-gutters">
				    ...
				    <div class="col-md-6">
				      <div class="card-body">
				        <p class="card-text">Biasanya kamar tipe Superior ini memiliki definisi yang berbeda-beda di setiap hotel. Terkadang merupakan kamar standard dengan ukuran dan fasiltias yang lebih. Atau juga terkadang mungkin merujuk ke kamar khusus dengan pemandangan atau lokasi yang lebih baik. Biasanya dikenal juga dengan nama Premium Room.<br><br>

						Sederhanya adalah merupakan kamar yang dilihat hotel lebih baik daripada Standard Room. Cara terbaik tentunya lebih baik Anda menanyakan terlebih dahulu fasilitas kamar Superior di hotel terkait.</p>
