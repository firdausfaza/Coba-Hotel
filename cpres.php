...
<div class="konten">
	<div class="container">
		<div class="text-center">
			<h2>President Class</h2>
		</div>
		<hr class="my-4">
	<div class="card mb-3 mt-4S" style="max-width: 100%;">
				  <div class="row no-gutters">
				    <div class="col-md-6 ">
				      <img src="bootstrap/img/ps.jpg" class="card-img" alt="Doubleroom">
				    </div>
				    <div class="col-md-6">
				      <div class="card-body">
				        <p class="card-text"><p>Presidental bisa dikatakan sebagai jenis kamar hotel suit room yang lebih luas lagi. Jenis kamar hotel ini adalah janis kamar yang terbaik dan termahal dari sebuah hotel. Tidak semua hotel memiliki presidental suit. Fasilitas yang diberikan kamar inipun merupakan fasilitas yang terbaik yang ditawarkan oleh hotel.<br>
				        	<br>

						Hotel juga biasanya akan memberikan pemandangan yang paling bagus untuk jenis kamar hotel ini. Kamar seperti ini biasanya digunakan oleh orang-orang penting, seperti pejabar, miliarder, hingga seorang presiden. </p></p>
