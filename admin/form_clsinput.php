...
if (isset($_POST["submit"])) {
    ...
    if (tambahclass($_POST)>0) {
      echo "<script>
            ...
            document.location.href = 'table_clsinput.php';
            </script>"; 
    }
    else{
     echo "<script>
  ...
  <div class="card-body">
    <form action="" method="post">
        ...
        <div class="form-group col-md-12">
            <label for="class">Kode Class</label>
            <input name="kdclass" placeholder="Class Hotel" class="form-control" id="kdclass" required >
            </div>
          <div class="form-group col-md-12">
            <label for="class">Class Name</label>
            <input name="rmnama" placeholder="Class Hotel" class="form-control" id="rmnama" required >
          </div>
          <div class="form-group col-md-12">
            <label for="harga">Harga Kamar</label>
            <input name="harga" type="text" class="form-control" id="harga" placeholder="Harga Kelas Kamar" required>
          </div>
          </div> <br>
        <div class="form-row">
          <div class="form-group col-md-12">
