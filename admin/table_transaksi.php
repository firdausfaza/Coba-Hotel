...
<div class="card">
  <div class="card-body">
    ...
    btn-sm float-right" ><b><a href="form_transaksi.php" style="color:#000; text-decoration: none;">+Add Data</a></b></button><br><br>
    </div>
  </div>
    ...
    <tr>
     <th width="20px;" scope="row"><?= $i; ?></th>
      ...
      $_SESSION["ttl"] = $ttl;
       ?>
      <td>
        <center><button type="button" class="btn btn-warning btn-sm"><a href="hapustr.php?id= <?= $row["id"];  ?>" style="color:#000; text-decoration: none;" onclick="return confirm('Ayakin anda akan menghapus data ini?');"><i class="far fa-trash-alt"></i></a></button></center>
      </td>
    </tr>
    <?php $i++ ?>
  <?php endwhile; ?>
