...
<div class="card">
  <div class="card-body">
    ...
    btn-sm float-right" ><b><a href="form_cls.php" style="color:#000; text-decoration: none;">+Add Data</a></b></button><br><br>
    </div>
  </div>
...
<table class="table table-striped table-bordered">
  ...
  <?php $harga = $row["harga"]; ?>
    <tr>
      ...
      <td>
        <center><button type="button" class="btn btn-warning btn-sm" ><a href="hapus.php?id= <?= $row["id"]; ?>" style="color:#000; text-decoration: none;" onclick="return confirm('Yakin anda akan menghapus data ini?');"><i class="far fa-trash-alt"></i></a></button></center>
      </td>
    </tr>
    <?php $i++ ?>
    <?php endwhile; ?>
