...
<html lang="en">
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav ml-auto">
  	...
  	<div class="isiadmin"> 
  	<h3>Customers Visitors</h3> <br><br>
<div class="card">
  <div class="card-body">
    <div class="row">
    <div class="col-md-6">
    <h5>Customers Visitors</h5>
    </div>
    ...
    <tr>
     <th width="20px;" scope="row"><?= $i; ?></th>
      ...
      $_SESSION["ttl"] = $ttl;
       ?>
       <td>
        <center><button type="button" class="btn btn-warning btn-sm"><a href="hapusvisit.php?id= <?= $row["id"];  ?>" style="color:#000; text-decoration: none;" onclick="return confirm('Ayakin anda akan menghapus data ini?');"><i class="far fa-trash-alt"></i></a></button></center>
      </td>
    </tr>
    <?php $i++ ?>
  <?php endwhile; ?>
