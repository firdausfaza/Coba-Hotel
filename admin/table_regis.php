...
$result = mysqli_query($koneksi, "SELECT * FROM  useradmin");
...
<div class="card">
  <div class="card-body">
    ...
    btn-sm float-right" ><b><a href="regis.php" style="color:#000; text-decoration: none;">+Add Data</a></b></button><br><br>
    </div>
  </div>
